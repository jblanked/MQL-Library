...
{
   private:
      bool GetPostData1(char &postData[], string &headers, string chat, string text, string fileName);
   ...
   public:
      void SendDiscordMessage(string discord_webhook, string message);
      void SendScreenshotToDiscord(string discord_webhook, string fileName, string symbol = NULL, ENUM_TIMEFRAMES timeframe = PERIOD_CURRENT, int height = 800, int width = 600, string fileType = "image/png");
      void telegramSendScreenhot(string fileName, string fileType, string inputChatId, string inputToken);
      bool SendTelegramMessage(string token, string chat, string text, string fileName = "");
};
//+------------------------------------------------------------------+
void CSocialMedia::SendDiscordMessage(string discord_webhook, string message)
{
    string strJsonText = "{\r\n  \"content\": \"" + message + "\"\r\n}";
    uchar jsonData[];
...
void CSocialMedia::SendScreenshotToDiscord(string discord_webhook, string fileName, string symbol, ENUM_TIMEFRAMES timeframe = PERIOD_CURRENT, int height = 800, int width = 600, string fileType = "image/png")
{
    ResetLastError();
...
//|                                                                  |
//+------------------------------------------------------------------+
void CSocialMedia::telegramSendScreenhot(string fileName, string fileType, string inputChatId, string inputToken)
{
  int    res;     
  string header;
  char   requestData[], responseData[];
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CSocialMedia::GetPostData1(char &postData[], string &headers, string chat, string text, string fileName)
  {
