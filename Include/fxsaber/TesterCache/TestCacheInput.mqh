...
//+------------------------------------------------------------------+
//| âõîäíûå ïàðàìåòðû òåñòèðîâàíèÿ                                   |
//+------------------------------------------------------------------+
struct TestCacheInput
{
  //   wchar_t           name[64];
  STRING64          name;
  int               flag;                    // îïòèìèçèðóåìûé ïàðàìåòð
  int               type;                    // òèï TYPE_XXX
  int               digits;                  // êîëè÷åñòâî çíàêîâ ïîñëå çàïÿòîé
  int               offset;                  // ñìåùåíèå â áóôåðå ïàðàìåòðîâ
  int               size;                    // ðàçìåð çíà÷åíèÿ ïàðàìåòðà â áóôåðå
  int Unknown;
...
//--- êåøèðóåìàÿ çàïèñü ñîäåðæèò íîìåð ïðîõîäà (ïðè ãåíåòèêå - íîìåð ïî ïîðÿäêó), ñòðóêòóðó ðåçóëüòàòîâ òåñòèðîâàíèÿ (åñëè ìàòåìàòèêà, òî 1 double), áóôåð îïòèìèçèðóåìûõ ïàðàìåòðîâ è ãåíåòè÷åñêèé ïðîõîä
