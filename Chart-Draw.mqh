...
public:
   ...
   void              Chart_Arrow(string name, enum_up_down up_down, double price, datetime time, color color_type, int width = 1, const int sub_window = 0, const int buyCode = 233, const int sellCode = 234);
...
//|                                                                  |
//+------------------------------------------------------------------+
void CChartDraw::Chart_Arrow(string name, enum_up_down up_down, double price, datetime time, color color_type, int width = 1, const int sub_window = 0, const int buyCode = 233, const int sellCode = 234)
  {
   object_name = name;
   ...
   if(!ObjectFound(object_name))
     {
      ...
      ObjectSetInteger(0, object_name, OBJPROP_ARROWCODE, up_down == Up ? buyCode : sellCode);
      ObjectSetInteger(0,object_name,OBJPROP_COLOR,color_type);
      ObjectSetInteger(0, object_name, OBJPROP_STYLE, STYLE_SOLID);
