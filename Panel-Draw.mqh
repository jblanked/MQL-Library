...
void CPanelDraw::CreateLabel(
  ...
  {
   labelObject.Create(NULL, labelName, 0, x1, y1, x2, y2);
...
void CPanelDraw::CreateButton(
...
)
  {
   ...
   buttonObject.Create(NULL, buttonName, 0, x1, y1, x2, y2);
...
void CPanelDraw::CreateBitmap(
...
)
  {
   ...
   bitmapObject.Create(NULL, bitmapName, 0, x1, y1, x2, y2);
...
void CPanelDraw::CreateInput(
...
)
  {
   ...
   inputObject.Create(NULL, inputName, 0, x1, y1, x2, y2);
